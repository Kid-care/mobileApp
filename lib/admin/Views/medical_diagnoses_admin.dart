...
import 'package:healthcare/admin/Views/add_medical_diagonal.dart';
...
class MedicalDiagnoses extends StatefulWidget {
  @override
  _MedicalDiagnosesState createState() => _MedicalDiagnosesState();
}

class _MedicalDiagnosesState extends State<MedicalDiagnoses> {
  ...
  Future<void> deleteDisease(String diseaseId) async {
    ...
    String categoryId =
        '663a30f85bfb6ddbdb483a6d'; // Replace with your categoryId
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => AddMedicalDiagnosPage(),
              ),
            ).then((_) {
