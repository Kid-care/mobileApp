...
class PregnantVaccinations extends StatefulWidget {
  @override
  _PregnantVaccinationsState createState() => _PregnantVaccinationsState();
}

class _PregnantVaccinationsState extends State<PregnantVaccinations> {
  ...
  Future<void> fetchVaccineCategories() async {
    ...
    try {
      var response = await http.get(Uri.parse(apiUrl),
          headers: <String, String>{'category': '662677eb9ad7dd36168b89ed'});
  ...
  Future<List<Vaccine>> fetchVaccines(String categoryId) async {
    String apiUrl =
        'http://3.129.148.71:3000/api/v1/Item/get_Item'; 
    try {
